...
void ATouch(){
  ...
  //Rate
  else if((Y >=664 ) && (Y <=934) && (X >= 315 ) && (X <=570)){
      currentdis = 6;
      dis = 22;
  }
}
...
void runproses(int volume, int times, int rate){
